app.controller('wlAttackeModalCtrl', function($scope, $modalInstance, currentWeapon) {

  $scope.currentWeapon = currentWeapon; 
  $scope.mod = 0;

  $scope.wlAttacke = function() {
    ...
    if($scope.probe === 1) {
      ...
      $scope.probeResultString = "Glückstreffer! Schaden x2";
      $scope.success = true;
      $scope.meister = true;
